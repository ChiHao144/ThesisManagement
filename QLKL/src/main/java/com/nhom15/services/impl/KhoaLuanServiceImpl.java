...
public class KhoaLuanServiceImpl implements KhoaLuanService {
    ...
    public void addOrUpdateKhoaLuan(KhoaLuan kl) {
        ...
        // --- Gán lại các liên kết bằng entity thật (tránh transient object) ---
        if (kl.getGvhd1() != null && kl.getGvhd1().getId() != null) {
        ...
        // --- Ràng buộc: Mỗi sinh viên chỉ có 1 khóa luận ---
        ...
        // --- Ràng buộc: gvhd1 ≠ gvhd2 và gvpb không trùng gvhd1/2 ---
        ...
        // --- Ràng buộc: Hội đồng chưa khóa và chưa vượt 5 khóa luận ---
        if (kl.getHoidongId() != null) {
            ...
            // --- Ràng buộc: Thành viên hội đồng không trùng GVHD/GVPB ---
        ...
        // --- Gửi mail nếu có phân công mới GVPB ---
        if (kl.getGvpb() != null) {
